  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden text-center transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
      ...
      <div className="p-6">
        ...
        <p className="mt-1 text-sm text-primary font-semibold">{member.role}</p>
        ...
        <div className="mt-4">
          <a 
            ...
            className="inline-flex items-center text-sm text-light-text hover:text-primary transition-colors"
          >
